use ts2zig_core::TypeId;
use ts2zig_ir_mir::{MirBlock, MirDecl, MirExpr, MirProgram, MirStmt};
...
mod tests {
    ...
    fn empty_function(id: u32, throws: Option<TypeId>) -> MirFunctionDecl {
        MirFunctionDecl {
            ...
            throws,
            body: ts2zig_ir_mir::MirBody::default(),
    ...
    fn function_without_throws_is_left_alone() {
        ...
        let mut program = MirProgram::new(ts2zig_core::ModuleId::from_raw(0));
    ...
    fn struct_decl_is_skipped() {
        use ts2zig_core::{FieldId, StructId, Visibility};
        use ts2zig_ir_mir::{MirFieldDecl, MirStructDecl};
